...
###################################################################.
# SCRIPT: CHANGE VALUES BY TAKEN INFO FROM ANOTHER TABLE
# For this example, the table will be written in the script but it 
# could be imported.
...
# * 3.2 Create a table with name changes (hardcoding) -----
